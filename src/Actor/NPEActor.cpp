    ...
    if (alertness != newAlertness) {
        ...
        switch (alertness) {
            case NPCAlertness::RELAXED:
                // NPC is relaxed, possibly decrease awareness? Maybe play an animation, or have them return to their
                // patrol route
                break;
            ...
            case NPCAlertness::ALERTED:
                // NPC is fully alerted, they should be on high alert and potentially engage in combat (Or dialogue?)
