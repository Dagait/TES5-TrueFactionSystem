 ...
 *
 * This function looks up a keyword in the game's data using its editor ID and returns the corresponding keyword object.
 *
 ...
 *
 * This function returns the player's disguise value for the specified faction, which may affect interactions with NPCs.
 *
 ...
 *
 * This function returns the bonus disguise value the player has for the specified faction, which may be derived from
 * armor sets or other factors.
 *
